...
/*  sub_orca2.c - Mex function gateway function for orca.f 
...
void orca_mex2 (double * uphalf_cp, double * uphalf_cs, double * uphalf_rho, double * uphalf_ap, double * uphalf_as, \
...
/* BD - comment */
	  printf("Checking inputs 2\n");

      above_sea =  mxGetPr(mxGetField(prhs[0], 0, "above_sea"));

/* BD - comment */
	  printf("Checking inputs 3\n");
