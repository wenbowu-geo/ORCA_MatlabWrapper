...
cyt         print *,'delph used: ',dreal(k)/kw0,dimag(k)*8685.9d0
      endif
...
c: Reset ph_step so that it does not start up again at very small values:
            ...
            iifail=2
cyt            if(iidiag .ge. 1) print *,'traj_mag stuck at XKREF: ',
cyt     .         dreal(k)/kw0,dimag(k)*8685.9
            return
         endif
cyt         print *,'ntry>10: ,ntry,k,k/kw0,iish = ',ntry,k,k/kw0
cyt         print *,'k,klast,delk = ',k/kw0,klast/kw0,delk/kw0
cyt         print *,'lnrr,lnlast,lnrrdes = ',lnr1r2,lnlast,lnrrdes
cyt         print *,'xkbp,iish = ',xkbp(1,1)/kw0,iish
cyt         print *,'xkref,iish_ref = ',xkref/kw0,iish_ref
cyt         print *,'num deriv = ',(lnr1r2-lnlast)/(k-klast),dlnlast,
cyt     .      dlnr1r2
...
cyt            if(iidiag .ge. 2) print *,'PATH HEADING TOWARD LOWER HP: ',
cyt     .         nmode,k,k/kw
            iilhp=1
...
cc          write(2,'(a)') 'Informative message: Mode search '//
cc   .         'terminating due to small Re(k) (see cphmax).'
cc       endif
         return
      endif
...
cyt            print *,'Total # tries exceeded 250 in traj_mag: ',
cyt     .         k/kw0,iish,dph_left
            iifail=1
cc          call stop_run
            return
         endif
...
cyt         print *,'ii_ext=1 in traj_hor: ',k/kw,ntryx
         ii_ext=1
         return
      endif
c
...
c
      ...
      if(iisg*iisg0 .lt. 0) then
cyt         print *,'ii_ext=1 in traj_ver: ',k/kw,ntryx
         ii_ext=1
         return
      endif
c
