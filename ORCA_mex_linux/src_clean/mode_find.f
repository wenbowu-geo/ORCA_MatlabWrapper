...
c
      call freq_init
c
cyt      if(iimt .ne. 0) call mode_traj_bp(rr_st)
...
c
         if(iiwrt .eq. 1) then
cyt            print *,'Informative message: Finished checking duct '//
cyt     .         'at depth ',zduct(kduct)
cyt            print *,'   # modes found in duct = ',nm_duct
cyt            write(2,'(a,f7.2)') 'Informative message: Finished '//
cyt     .         'checking duct at depth ',zduct(kduct)
cyt            write(2,'(a,i4)') '   # modes found in duct = ',nm_duct
         endif
c
199      continue
c
